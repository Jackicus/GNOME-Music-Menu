// Music Menu in the shell's own pictures of a workspace: the Activities
...
export class OverviewPreview {
    ...
    _attach() {
        ...
        for (const workspace of this._workspacePreviews()) {
            ...
            // Music Menu only ever draws on the primary monitor, so the other
