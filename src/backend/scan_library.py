#!/usr/bin/env python3
"""Index the media library and write the library.json Music Menu reads.
...
SCHEMA = "org.gnome.shell.extensions.music-menu"
...
def main():
    ...
    # (MUSIC_MENU_TMDB_KEY) for a standalone run. Never argv.
