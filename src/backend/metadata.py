"""Online metadata and artwork, cached under ~/.cache/music-menu.
...
(MUSIC_MENU_TMDB_KEY). Neither is ever argv, so they do not show up in `ps`.
...
CACHE_DIR = os.path.expanduser("~/.cache/music-menu")
...
class MetadataService:
    ...
    def __init__(self, online=True, sources=None, credentials=None, offline_kinds=()):
        ...
        self._env_credentials = {
            "tmdb": (os.environ.get("MUSIC_MENU_TMDB_KEY") or "").strip(),
        }
